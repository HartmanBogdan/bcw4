...
MageState::MageState(Unit* owner) {
    this->ownerunit = owner;
}
MageState::~MageState(){}

void MageState::attack(Unit* enemy) {
     if ( enemy->GetHP() > 0 ) {
...
void MageState::ContAttack(Unit* enemy) {
     if (enemy->GetID() != 2 ) {
